...
$id = $_SESSION["UID"];
$res = getThis("SELECT `fullName`,`phoneNumber`,`emailAddress`,`dob` FROM `doctors` WHERE `id` = '$id'");
$res = $res[0];
?>
<!DOCTYPE html>
<html class="no-js">
			...
			<section>
				<div class="content-header">
					<div class="row">
						...
						<button class="col-2 col-md-2 btn logout"><i class="fas fa-sign-out-alt"></i> <a href="logout.php">logout</a></button>
			...
			<section id="Appointment">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-6">
							<?php
							$result = getThis("SELECT * FROM `messages` WHERE `doctorID` = '$id' AND `enabled` = '0' ORDER BY `generatedAt` DESC");
